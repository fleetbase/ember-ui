    ...
    return {
        compile: {
            ...
            plugins: [
                ...
                // but always flatten nesting: the addon styles nest freely, and the
                // production minifier (clean-css) cannot parse native nesting, so an
                // unflattened block loses every nested rule, including the ones
                // that hide a tooltip until it is shown.
                postcssPresetEnv({ stage: 1, browsers, autoprefixer: false, features: { 'nesting-rules': true } }),
                postcssEach,
