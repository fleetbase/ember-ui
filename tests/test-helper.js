...
//
// The POST to /write-coverage carries ~1.9 MB for this addon, because a per-file 100% gate needs
// every module force-loaded. In CI mode testem tears the browser down as soon as QUnit reports the
// run finished, which truncates that upload mid-body — the server logs
// `BadRequestError: request aborted` from raw-body and writes nothing at all. It is size-dependent,
// so it looks like flakiness: measured here, fast filtered runs produced an artifact about 2 times
