...
module('Integration | Helper | place-address', function (hooks) {
    ...
    test('it renders the place title by default', async function (assert) {
        ...
        await render(hbs`{{place-address this.place}}`);
    ...
    test('it hides the place title when showTitle is false', async function (assert) {
        ...
        await render(hbs`{{place-address this.place showTitle=false}}`);
