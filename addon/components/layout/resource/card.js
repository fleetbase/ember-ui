...
export default class LayoutResourceCardComponent extends Component {
    ...
    get cardClass() {
        const baseClasses = 'bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden';
        return this.args.class ? `${baseClasses} ${this.args.class}` : baseClasses;
    }

    get headerClass() {
        const baseClasses = 'px-4 py-3 border-b border-gray-200 dark:border-gray-700';
    ...
    get footerClass() {
        const baseClasses = 'px-4 py-3 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50';
