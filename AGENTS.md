...
Shared Ember.js UI component library used across Fleetbase frontend applications and engines.

## Allowed Work

- Bug fixes and small enhancements to shared UI components, styles, interactions, and accessibility.
- Tests, documentation, examples, and compatibility fixes that preserve component conventions.
- Component API changes only when downstream and documentation impact are evaluated.

## Restricted Work

- Breaking component API, theme, layout, or design-system changes without explicit approval.
- Large UI library rewrites without review.
- User-facing component behavior changes without checking documentation impact.
...
- Lint: `pnpm lint`
- Tests: `pnpm test` or `pnpm test:ember`
- Build: `pnpm build`
